...
public class BlogService {
    ...
    optionalBoard.ifPresent(board -> {
        board.update(
            request.getTitle(),
            request.getContent(),
            request.getUser() != null ? request.getUser() : board.getUser(),
            request.getNewdate() != null ? request.getNewdate() : board.getNewdate(),
            request.getCount() != null ? request.getCount() : board.getCount(),
            request.getLikec() != null ? request.getLikec() : board.getLikec()
        );
